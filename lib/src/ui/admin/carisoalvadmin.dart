...
import '../../provider/searchprov.dart';
import '../../service/realdb_api.dart';
import 'buatPaketsoal.dart';
import 'detilsoal.dart';
import 'listnilai_page.dart';
    ...
    Widget _buildButtonTingkat(String titel) {
      return Padding(
        ...
        child: FlatButton(
          ...
          onPressed: () {
            search.tingkat = titel;
          },
          color: search.tingkat == titel ? Colors.blue : Colors.grey,
        ),
      );
    }

    Widget _builButtonindialog(
        {String titel, VoidCallback ontap, Color color}) {
      return Padding(
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () => Navigator.push(
                context, MaterialPageRoute(builder: (_) => BuatPaketSoalPage()))
            .then((_) => setState(() {})),
      ),
      key: UniqueKey(),
      appBar: AppBar(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            Divider(),
            (search.kelas == null || search.mapel == null)
                ? Container()
                                                              ...
                                                              children: <
                                                                ...
                                                                val.published
                                                                    ? _builButtonindialog(
                                                                        titel:
                                                                            'Unpublish',
                                                                        ontap: () => db.unPublishSoalV2(val.kelas, val.mapel, val.id).then((_) =>
                                                                            Navigator.pop(
                                                                                context)))
                                                                    : _builButtonindialog(
                                                                        titel:
                                                                        ...
                                                                        builder: (__) =>
                                                                            AlertDialog(
                                                                              ...
                                                                              actions: <Widget>[
                                                                                ...
                                                                                FlatButton(
                                                                                  child: Text('Oke Hapus', style: TextStyle(color: Colors.red)),
                                                                                  onPressed: () => db.hapusPaketSoal(val).then((_) => Navigator.pop(context)),
                                                                                ),
                                                                              ],
                                                                            )).then((_) =>
                                                                        Navigator.pop(
