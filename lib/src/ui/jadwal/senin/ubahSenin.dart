...
class UbahSenin extends StatefulWidget {
  final JadwalModel jadwal;
  UbahSenin({this.jadwal});
  @override
  _UbahSeninState createState() => _UbahSeninState();
}

class _UbahSeninState extends State<UbahSenin> {
  String pengajar;
          ...
          if (pengajar == "R. Ananta WK") {
            FirebaseDatabase.instance
              ...
              Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                      builder: (BuildContext context) => Senin()));
            });
