...
class Ubahjumat extends StatefulWidget {
  final JadwalModel jadwal;
  Ubahjumat({this.jadwal});
  @override
  _UbahjumatState createState() => _UbahjumatState();
}

class _UbahjumatState extends State<Ubahjumat> {
  String pengajar;
          ...
          if (pengajar == "R. Ananta WK") {
            FirebaseDatabase.instance
              ...
              Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                      builder: (BuildContext context) => Jumat()));
            });
