...
class Ubahkamis extends StatefulWidget {
  final JadwalModel jadwal;
  Ubahkamis({this.jadwal});
  @override
  _UbahkamisState createState() => _UbahkamisState();
}

class _UbahkamisState extends State<Ubahkamis> {
  String pengajar;
          ...
          if (pengajar == "R. Ananta WK") {
            FirebaseDatabase.instance
              ...
              Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                      builder: (BuildContext context) => Kamis()));
            });
