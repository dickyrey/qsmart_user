...
class UbahSelasa extends StatefulWidget {
  final JadwalModel jadwal;
  UbahSelasa({this.jadwal});
  @override
  _UbahSelasaState createState() => _UbahSelasaState();
}

class _UbahSelasaState extends State<UbahSelasa> {
  String pengajar;
          ...
          if (pengajar == "R. Ananta WK") {
            FirebaseDatabase.instance
              ...
              Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                      builder: (BuildContext context) => Selasa()));
            });
