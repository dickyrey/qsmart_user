...
class Ubahsabtu extends StatefulWidget {
  final JadwalModel jadwal;
  Ubahsabtu({this.jadwal});
  @override
  _UbahsabtuState createState() => _UbahsabtuState();
}

class _UbahsabtuState extends State<Ubahsabtu> {
  String pengajar;
          ...
          if (pengajar == "R. Ananta WK") {
            FirebaseDatabase.instance
              ...
              Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                      builder: (BuildContext context) => Sabtu()));
            });
